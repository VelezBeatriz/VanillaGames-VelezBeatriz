const l={template:`
  ...
  `,script:()=>{document.querySelector("#botonVolver").addEventListener("click",()=>{window.history.back()});const o=document.querySelector("#formularioNuevoPRoyecto");o.addEventListener("submit",e=>{e.preventDefault(),e.stopPropagation(),o.checkValidity()?t():o.classList.add("was-validated")});function t(){const e={imagen:document.querySelector("#urlImagen").value,nombre:document.querySelector("#nombreJuego").value,descripcion:document.querySelector("#descripcion").value,fecha:document.querySelector("#fecha").value,estado:document.querySelector("#estado").value,enlace:document.querySelector("#enlace").value,repositorio:document.querySelector("#repositorio").value};alert("Enviando proyecto a la base de datos"),console.log("Enviando a la base de datos ",e)}}};export{l as default};
