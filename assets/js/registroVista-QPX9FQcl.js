const e={template:`
  ...
  `,script:()=>{const l=document.querySelector("form");l.addEventListener("submit",a=>{l.checkValidity()||(a.preventDefault(),a.stopPropagation()),l.classList.add("was-validated")})}};export{e as default};
